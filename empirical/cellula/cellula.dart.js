...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": ""
  }], ["cellula", "cellula.dart",, Z, {
    "^": "",
    main: function() {
      new Z.Cellula(new Z.Host(false, H.setRuntimeTypeInfo([], [Z.Cell])), false, false, P.List_List$filled(250, false, false, P.bool)).Empirical$0();
    },
    Cell: {
      "^": "LivingEntity;Moving_speed,Moving_speedX,Moving_speedY,Living_health,Living_maxHealth,Living_murderer,sprite,x,y,width,height,dead"
    },
    Cellula: {
      "^": "Empirical;host,started,paused,keys"
    },
    Host: {
      "^": "Object;created,cells",
      spawnCells$1: function(quantity) {
        var t1, x, e, t2, t3, t4;
        for (t1 = this.cells, x = 0; x < quantity; ++x) {
          e = document.createElement("img");
          e.src = "sprite\\cell.gif";
          t2 = new Z.Cell(1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
          t3 = $.$get$random();
          t4 = $.$get$canvas();
          t2.x = t3.nextInt$1(t4.width);
          t2.y = t3.nextInt$1(t4.height);
      ...
      draw$0: function() {
        ...
        for (t1 = this.cells, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          cell = t1[_i];
          $.$get$context().drawImage(cell.sprite, cell.x, cell.y, cell.width, cell.height);
        }
      }
    }
  }, 1], ["empirical", "../../empirical.dart",, T, {
    "^": "",
    ...
    Empirical: {
      ...
      Empirical$0: function() {
        var oldMenu = T.getMenu(C.MainMenu_2EC);
        if (oldMenu != null)
          C.JSArray_methods.remove$1($.$get$ALL_MENUS(), oldMenu);
        C.JSArray_methods.add$1($.$get$ALL_MENUS(), C.MainMenu_2EC);
    ...
    _LivingEntity_Entity_Living_Moving: {
      "^": "_LivingEntity_Entity_Living+Moving;"
    }
  }]];
...
;
  ...
  }, "_Html5NodeValidator__attributeValidators", "random", "$get$random", function() {
    return C.C__JSRandom;
  }, "random", "ALL_MENUS", "$get$ALL_MENUS", function() {
...
//# sourceMappingURL=cellula.dart.js.map
