...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "ArrayBuffer|Blob|CanvasGradient|CanvasPattern|Client|DOMError|DOMImplementation|File|MediaError|Navigator|NavigatorConcurrentHardware|NavigatorUserMediaError|OverconstrainedError|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGL2RenderingContext|WebGLRenderingContext|WindowClient"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 4, 2, 17],
      $isFuture: 1,
      static: {
    ...
    HtmlElement: {
      "^": "Element;",
      "%": "HTMLAudioElement|HTMLBRElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMediaElement|HTMLMenuElement|HTMLMetaElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLParagraphElement|HTMLPictureElement|HTMLPreElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSlotElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableHeaderCellElement|HTMLTimeElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLVideoElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
    ...
    SelectElement: {
      ...
      get$options: function(receiver) {
        var t1, options;
        t1 = W.OptionElement;
        H.assertIsSubtype(t1, W.Element, "The type argument '", "' is not a subtype of the type variable bound '", "' of type variable 'T' in 'querySelectorAll'.");
        options = new W._FrozenElementList(receiver.querySelectorAll("option"), [t1]);
        return new P.UnmodifiableListView(H.assertSubtype(options.toList$0(options), "$isIterable", [t1], "$asIterable"), [t1]);
      },
      $isSelectElement: 1,
      "%": "HTMLSelectElement"
    },
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 16, 0, 13],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 16, 0, 13]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    getMenu: function(menu) {
      ...
      else if (!!menu.$isOptionsMenu)
        return C.JSArray_methods.firstWhere$1($.$get$ALL_MENUS(), new T.getMenu_closure1());
      else if (!!menu.$isGameMenu)
        return C.JSArray_methods.firstWhere$1($.$get$ALL_MENUS(), new T.getMenu_closure2());
      else
        return;
    },
    loadMenu: function(newMenu) {
      var oldMenu = T.getMenu(newMenu);
      if (oldMenu != null)
        C.JSArray_methods.remove$1($.$get$ALL_MENUS(), oldMenu);
      C.JSArray_methods.add$1($.$get$ALL_MENUS(), newMenu);
    },
    ...
    Empirical: {
      ...
      Empirical$0: function() {
        T.loadMenu(C.MainMenu_cln);
        T.loadMenu(C.PauseMenu_KKq);
        T.loadMenu(C.OptionsMenu_ES6);
      ...
      exitMenu$0: function() {
        switch (J.get$runtimeType$($.currentMenu)) {
          ...
          case C.Type_PauseMenu_6Re:
            this.started = false;
            this.universe.destroyUniverse$0();
            this.ticks = 0;
      ...
      _tick$1: [function(time) {
        ...
        if (!this.paused && this.started) {
          this._draw$0();
          if (++this.ticks === this.ticksDisease) {
            this.universe.generateUniverse$0();
            this.ticks = 0;
          }
        }
        C.Window_methods.requestAnimationFrame$1(window, this.get$_tick());
      }, "call$1", "get$_tick", 4, 0, 24],
      _draw$0: function() {
        var t1, t2;
        t1 = $.$get$context();
        t1.fillStyle = "black";
    ...
    Empirical_loadEvents_closure3: {
      "^": "Closure:5;$this,fullscreenToggle",
      call$1: function($event) {
        var t1;
        H.interceptedTypeCheck($event, "$isMouseEvent");
        ...
        t1 = this.$this;
        T.resizeCanvas();
        t1.universe.resize$0(0);
        t1._draw$0();
      }
    },
    Empirical_loadEvents_closure4: {
      "^": "Closure:5;$this,mobileToggle",
      call$1: function($event) {
        var t1;
        H.interceptedTypeCheck($event, "$isMouseEvent");
    ...
    Empirical_loadEvents_closure7: {
      "^": "Closure:5;$this",
      call$1: function($event) {
        var t1, t2, t3, t4, t5, t6, t7, t8, locX;
        H.interceptedTypeCheck($event, "$isMouseEvent");
        t1 = this.$this;
        if (!t1.paused && t1.started) {
          ...
          $event.pageY;
          t3 = $.$get$canvas();
          t4 = C.JSNumber_methods.round$0(t3.offsetLeft);
          t5 = C.JSNumber_methods.round$0(t3.scrollLeft);
          if (typeof t2 !== "number")
            return t2.$sub();
          t6 = $event.pageY;
          t7 = C.JSNumber_methods.round$0(t3.offsetTop);
          t3 = C.JSNumber_methods.round$0(t3.scrollTop);
          if (typeof t6 !== "number")
            return t6.$sub();
          t1 = t1.universe;
          t8 = t1.tileWidth;
          if (typeof t8 !== "number")
            return H.iae(t8);
          locX = C.JSDouble_methods.floor$0((t2 - (t4 - t5)) / t8);
          t8 = t1.tileHeight;
          if (typeof t8 !== "number")
            return H.iae(t8);
          C.JSArray_methods.$indexSet(t1.dimension, C.JSDouble_methods.floor$0((t6 - (t7 - t3)) / t8) * 100 + locX, 5);
        }
      }
    },
    ...
    getMenu_closure1: {
      "^": "Closure:3;",
      call$1: function(element) {
        return H.interceptedTypeCheck(element, "$isMenu") instanceof T.OptionsMenu;
      }
    },
    getMenu_closure2: {
      "^": "Closure:3;",
  ...
  }], ["empirical_universe", "universe.dart",, V, {
    "^": "",
    main: function() {
      var t1 = new Array(10000);
      t1.fixed$length = Array;
      t1 = new V.Universe(false, C.C__JSRandom, H.setRuntimeTypeInfo(t1, [P.int]), 1, 3, 3);
      t1.resize$0(0);
      new V.EmpiricalUniverse(t1, 0, 20, false, false, P.List_List$filled(250, false, false, P.bool)).Empirical$0();
    },
    Universe: {
      "^": "Object;created,random,dimension,infection,mutation,tainted,0tileWidth,0tileHeight",
      parseSeverity$1: function(input) {
        if (input === "demonic")
          return 1;
      ...
      generateUniverse$2$infectionRate$mutationRate: function(infectionRate, mutationRate) {
        var t1, t2, x, y, t3, t4;
        if (infectionRate != null)
          this.infection = this.parseSeverity$1(infectionRate.toLowerCase());
        if (mutationRate != null)
          this.mutation = this.parseSeverity$1(mutationRate.toLowerCase());
        for (t1 = this.dimension, t2 = this.random, x = 0; x < 100; ++x)
          for (y = 0; y < 100; ++y) {
            t3 = y * 100 + x;
            if (t3 >= 10000)
            ...
            t4 = t1[t3];
            if (t4 !== 5 && t4 !== 6)
              C.JSArray_methods.$indexSet(t1, t3, t2.nextInt$1(5));
          }
        this.explodeCompactions$0();
        this.created = true;
      },
      generateUniverse$0: function() {
        return this.generateUniverse$2$infectionRate$mutationRate(null, null);
      },
      explodeCompactions$0: function() {
        var t1, t2, t3, x, y, index, t4, above, below, left, right, current;
        for (t1 = this.tainted, t2 = this.dimension, t3 = [P.int], x = 0; x < 100; ++x) {
          if (x === 0 || x === 99)
            continue;
          for (y = 0; y < 100; ++y) {
            if (y === 0 || y === 99)
            ...
            switch (this.mutation) {
              case 1:
                if (this.equivalent$2(current, H.setRuntimeTypeInfo([above, below], t3)) || this.equivalent$2(current, H.setRuntimeTypeInfo([above, left], t3)) || this.equivalent$2(current, H.setRuntimeTypeInfo([left, right], t3)) || this.equivalent$2(current, H.setRuntimeTypeInfo([right, below], t3)))
                  C.JSArray_methods.$indexSet(t2, index, 5);
                break;
              case 2:
                if (this.equivalent$2(current, H.setRuntimeTypeInfo([right, left], t3)) || this.equivalent$2(current, H.setRuntimeTypeInfo([above, below], t3)))
                  C.JSArray_methods.$indexSet(t2, index, 5);
                break;
              case 3:
                if (this.equivalent$2(current, H.setRuntimeTypeInfo([above, below, right, left], t3)))
                  C.JSArray_methods.$indexSet(t2, index, 5);
                break;
            }
            if (current !== 6)
              switch (this.infection) {
                case 1:
                  if (this.equivalent$2(5, H.setRuntimeTypeInfo([above, below], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([above, left], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([left, right], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([left, below], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([right, above], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([right, below], t3)))
                    C.JSArray_methods.$indexSet(t2, index, 5);
                  break;
                case 2:
                  if (this.equivalent$2(5, H.setRuntimeTypeInfo([above, below], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([above, left], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([left, right], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([right, below], t3)))
                    C.JSArray_methods.$indexSet(t2, index, 5);
                  break;
                case 3:
                  if (this.equivalent$2(5, H.setRuntimeTypeInfo([above, below], t3)) || this.equivalent$2(5, H.setRuntimeTypeInfo([left, right], t3)))
                    C.JSArray_methods.$indexSet(t2, index, 5);
                  break;
              }
            switch (t1) {
              ...
              case 2:
              case 3:
                if (this.equivalent$2(5, H.setRuntimeTypeInfo([current, left, right, above, below], t3)))
                  C.JSArray_methods.$indexSet(t2, index, 6);
                break;
            }
          }
        }
      },
      equivalent$2: function(target, comparison) {
        var t1, _i, base;
        H.assertSubtype(comparison, "$isList", [P.int], "$asList");
        for (t1 = comparison.length, _i = 0; _i < t1; ++_i) {
          base = comparison[_i];
      ...
      destroyUniverse$0: function() {
        var t1, x;
        this.created = false;
        for (t1 = this.dimension, x = 0; x < 10000; ++x)
          C.JSArray_methods.$indexSet(t1, x, 0);
      },
      resize$0: function(_) {
        var t1, t2;
        t1 = $.$get$canvas();
        ...
        if (typeof t2 !== "number")
          return t2.$div();
        this.tileWidth = t2 / 100;
        t1 = t1.height;
        if (typeof t1 !== "number")
          return t1.$div();
        this.tileHeight = t1 / 100;
      },
      draw$0: function() {
        var t1, x, t2, t3, y, t4, tileId, t5, t6;
        if (this.created)
          for (t1 = this.dimension, x = 0; x < 100; ++x)
            for (t2 = x !== 0, t3 = x !== 99, y = 0; y < 100; ++y) {
              t4 = y * 100 + x;
              if (t4 >= 10000)
              ...
              if (typeof t6 !== "number")
                return H.iae(t6);
              t4.fillRect(x * t5, y * t6, t5, t6);
            }
      }
    },
    EmpiricalUniverse: {
      "^": "Empirical;universe,ticks,ticksDisease,started,paused,keys",
      start$0: function(_) {
        var t1, dropDown, t2, t3, infectionDropDown, infection, mutationDropDown;
        t1 = document;
        dropDown = H.interceptedTypeCheck(t1.querySelector("#ticksdisease"), "$isSelectElement");
        t2 = (dropDown && C.SelectElement_methods).get$options(dropDown);
        t3 = dropDown.selectedIndex;
        t2 = t2._source;
        if (t3 >>> 0 !== t3 || t3 >= t2.length)
          return H.ioore(t2, t3);
        this.ticksDisease = P.int_parse(J.get$value$x(t2[t3]), null, null);
        infectionDropDown = H.interceptedTypeCheck(t1.querySelector("#infectionrate"), "$isSelectElement");
        t3 = (infectionDropDown && C.SelectElement_methods).get$options(infectionDropDown);
        t2 = infectionDropDown.selectedIndex;
        t3 = t3._source;
        if (t2 >>> 0 !== t2 || t2 >= t3.length)
          return H.ioore(t3, t2);
        infection = J.get$value$x(t3[t2]);
        mutationDropDown = H.interceptedTypeCheck(t1.querySelector("#mutationrate"), "$isSelectElement");
        t1 = (mutationDropDown && C.SelectElement_methods).get$options(mutationDropDown);
        t2 = mutationDropDown.selectedIndex;
        t1 = t1._source;
        if (t2 >>> 0 !== t2 || t2 >= t1.length)
          return H.ioore(t1, t2);
        this.universe.generateUniverse$2$infectionRate$mutationRate(infection, J.get$value$x(t1[t2]));
      }
    }
  }, 1]];
...
;
  ...
  C.PauseMenu_KKq = new T.PauseMenu("pausemenu", '<h1>Universe Paused</h1>\n    <a id="pausebutton">Resume</a>\n    <a id="exitbutton">Exit</a>');
...
//# sourceMappingURL=universe.dart.js.map
