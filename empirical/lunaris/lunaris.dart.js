// Generated by dart2js (full emitter, strong), the Dart to JavaScript compiler version: 2.0.0-dev.69.5.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "ArrayBuffer|Blob|CanvasGradient|CanvasPattern|DOMError|DOMImplementation|File|MediaError|Navigator|NavigatorConcurrentHardware|NavigatorUserMediaError|OverconstrainedError|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGL2RenderingContext|WebGLRenderingContext"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    _TimerImpl: {
      "^": "Object;_once,0_handle,_async$_tick",
    ...
    List_List$filled: function($length, fill, growable, $E) {
      var result, i;
      H.assertSubtypeOfRuntimeType(false, $E);
      if (false)
        result = H.setRuntimeTypeInfo(new Array($length), [$E]);
      else
        result = J.JSArray_JSArray$fixed($length, $E);
      if ($length !== 0 ? true : false)
        for (i = 0; i < result.length; ++i)
          C.JSArray_methods.$indexSet(result, i, false);
    ...
    CssStyleDeclarationBase: {
      ...
      resize$4: function($receiver, arg0, arg1, arg2, arg3) {
        return this.get$resize($receiver).call$4(arg0, arg1, arg2, arg3);
      }
    },
    DomException: {
      "^": "Interceptor;",
    ...
    EventTarget: {
      ...
      $isEventTarget: 1,
      "%": "MIDIInput|MIDIOutput|MIDIPort|MediaStream;EventTarget"
    },
    FormElement: {
      "^": "HtmlElement;0length=",
      "%": "HTMLFormElement"
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 16, 0, 17],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 16, 0, 17]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    _RectangleBase: {
      ...
      $eq: function(_, other) {
        ...
        if (other == null)
          return false;
        t1 = H.checkSubtypeV2(other, "$isRectangle", [P.num], null);
        if (!t1)
          return false;
        t1 = this.left;
        t2 = J.getInterceptor$x(other);
        if (t1 === t2.get$left(other)) {
          ...
          if (t3 === t2.get$top(other)) {
            ...
            t5 = H.getTypeArgumentByIndex(other, 0);
            t1 = H.assertSubtypeOfRuntimeType(t1 + this.width, t4) === H.assertSubtypeOfRuntimeType(t2.get$left(other) + t2.get$width(other), t5) && H.assertSubtypeOfRuntimeType(t3 + this.height, t4) === H.assertSubtypeOfRuntimeType(t2.get$top(other) + t2.get$height(other), t5);
          } else
            t1 = false;
        } else
          t1 = false;
      ...
      get$hashCode: function(_) {
        ...
        t4 = H.assertSubtypeOfRuntimeType(t1 + this.width, t3);
        t3 = H.assertSubtypeOfRuntimeType(t2 + this.height, t3);
        return P._JenkinsSmiHash_finish(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(P._JenkinsSmiHash_combine(0, t1 & 0x1FFFFFFF), t2 & 0x1FFFFFFF), t4 & 0x1FFFFFFF), t3 & 0x1FFFFFFF));
      }
    },
    Rectangle: {
      ...
      static: {
        Rectangle$: function(left, $top, width, height, $T) {
          var t1 = H.assertSubtypeOfRuntimeType(width < 0 ? -width * 0 : width, $T);
          return new P.Rectangle(left, $top, t1, H.assertSubtypeOfRuntimeType(height < 0 ? -height * 0 : height, $T), [$T]);
        }
      }
    }
    ...
    "^": ""
  }], ["empirical", "../../empirical.dart",, T, {
    "^": "",
    createAllMenus: function() {
      var t1, t2, _i;
      for (t1 = $.$get$ALL_MENUS(), t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
        t1[_i].create$0();
    },
    getMenu: function(menu) {
      if (!!menu.$isMainMenu)
        return C.JSArray_methods.firstWhere$1($.$get$ALL_MENUS(), new T.getMenu_closure());
      else if (!!menu.$isPauseMenu)
        return C.JSArray_methods.firstWhere$1($.$get$ALL_MENUS(), new T.getMenu_closure0());
      else if (!!menu.$isGameMenu)
        return C.JSArray_methods.firstWhere$1($.$get$ALL_MENUS(), new T.getMenu_closure1());
      else
        return;
    },
    resizeCanvas: function() {
      if ($.FULLSCREEN_MODE) {
        var t1 = document.querySelector("#gametitle").style;
        t1.display = "none";
        t1 = $.$get$canvas();
        t1.width = window.innerWidth;
        t1.height = window.innerHeight;
      } else if ($.MOBILE_MODE) {
        t1 = document.querySelector("#gametitle").style;
        t1.display = "none";
        t1 = $.$get$canvas();
        t1.width = 440;
        t1.height = 660;
    ...
    Empirical: {
      "^": "Object;",
      Empirical$0: function() {
        var oldMenu = T.getMenu(C.MainMenu_Jhy);
        if (oldMenu != null)
          C.JSArray_methods.remove$1($.$get$ALL_MENUS(), oldMenu);
        C.JSArray_methods.add$1($.$get$ALL_MENUS(), C.MainMenu_Jhy);
        this.super$Empirical$loadInterface();
        this.loadEvents$0();
        C.Window_methods.requestAnimationFrame$1(window, this.get$_tick());
      },
      loadInterface$0: ["super$Empirical$loadInterface", function() {
        var t1, t2, t3, t4, t5;
        t1 = $.$get$canvas();
        t1.id = "gamecanvas";
        t2 = $.$get$style();
        ...
        t3 = $.$get$title();
        t3.id = "gametitle";
        t3.textContent = "Empirical";
        t4 = document;
        t5 = t4.body;
        new W._ChildrenElementList(t5, t5.children).addAll$1(0, H.setRuntimeTypeInfo([t2, t3, t1], [W.Element]));
        T.resizeCanvas();
        t1 = "body {\n    font-family: 'Open Sans', sans-serif;\n  line-height: 1.2em;\n  margin: 0px;\n  overflow: hidden;\n  -moz-user-select: none;\n  -webkit-user-select: none;\n  -user-select: none;\n\n}\nform {\n  padding: 10px;\n}\ninput, select {\n  margin: 3px -240px 3px 4px;\n}\nselect {\n  width: 100px;\n}\n#label {\n  margin-left: -40%;\n  margin-bottom: -25px;\n}\n.popup {\n  " + ("  top: 75px; \n  display: none;\n  position: absolute;\n  text-align: center;\n  color: white;\n  border: 7px solid rgb(221,212,193);\n  margin: 40px;\n  background-color: rgb(66, 56, 56);\n  width: " + $.popupWidth + "px;\n  padding-bottom: 20px;\n  left: 50%;\n  margin-left: -" + H.S($.popupWidth / 2 + 8) + "px;\n") + "\n}\n.popup h1 {\n    font-family: Roboto;\n  padding-top: 10px;\n\n}\n.popup a {\n  " + ("  float: left;\n  padding: 10px 80px 10px 80px;\n  border: grey solid 1px;\n  background-color: #E0E0E0;\n  margin-top: 20px;\n  margin-bottom: 20px;\n  width: 10%;\n  color: black;\n  clear: both;\n  margin-left: " + H.S($.popupWidth * 0.26) + "px;\n") + "\n}\n.popup a:hover {\n    background-color: #D8D8D8;\n  color: grey;\n  cursor: pointer;\n\n}\n#gamecanvas {\n    padding-left: 0;\n  padding-right: 0;\n  margin-left: auto;\n  margin-right: auto;\n  display: block;\n\n}\n#gametitle {\n    text-align: center;\n  font-family: Impact;\n  letter-spacing: 2px;\n  font-size: 36px;\n\n}\n";
        t2.toString;
        t2.appendChild(t4.createTextNode(t1));
        T.createAllMenus();
        T.resizeCanvas();
        this.station.resize$0(0);
        this._draw$0();
        t1 = T.getMenu(C.MainMenu_ohJ);
        $.currentMenu.hide$0();
        $.currentMenu = t1;
        t1.show$0(0);
      }],
      loadEvents$0: function() {
        var t1, startButton, t2, t3, pauseButtons, optionsButtons, exitButtons, mobileToggle, fullscreenToggle;
        t1 = document;
        startButton = t1.querySelector("#startbutton");
        t2 = W.Element;
        ...
        t3 = [t2];
        pauseButtons = new W._FrozenElementList(t1.querySelectorAll("#pausebutton"), t3);
        H.assertIsSubtype(t2, t2, "The type argument '", "' is not a subtype of the type variable bound '", "' of type variable 'T' in 'querySelectorAll'.");
        optionsButtons = new W._FrozenElementList(t1.querySelectorAll("#optionsbutton"), t3);
        H.assertIsSubtype(t2, t2, "The type argument '", "' is not a subtype of the type variable bound '", "' of type variable 'T' in 'querySelectorAll'.");
        exitButtons = new W._FrozenElementList(t1.querySelectorAll("#exitbutton"), t3);
        mobileToggle = t1.querySelector("#mobiletoggle");
        fullscreenToggle = t1.querySelector("#fullscreentoggle");
        if (startButton != null) {
          t1 = J.get$onClick$x(startButton);
          t2 = H.getTypeArgumentByIndex(t1, 0);
          W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new T.Empirical_loadEvents_closure(this), {func: 1, ret: -1, args: [t2]}), false, t2);
        }
        pauseButtons.forEach$1(pauseButtons, new T.Empirical_loadEvents_closure0(this));
        optionsButtons.forEach$1(optionsButtons, new T.Empirical_loadEvents_closure1());
        exitButtons.forEach$1(exitButtons, new T.Empirical_loadEvents_closure2(this));
        if (mobileToggle != null && fullscreenToggle != null) {
          t1 = J.get$onClick$x(mobileToggle);
          t2 = H.getTypeArgumentByIndex(t1, 0);
          W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new T.Empirical_loadEvents_closure3(this, fullscreenToggle), {func: 1, ret: -1, args: [t2]}), false, t2);
          t2 = J.get$onClick$x(fullscreenToggle);
          t1 = H.getTypeArgumentByIndex(t2, 0);
          W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new T.Empirical_loadEvents_closure4(this, mobileToggle), {func: 1, ret: -1, args: [t1]}), false, t1);
        }
        t1 = W.KeyboardEvent;
        t2 = {func: 1, ret: -1, args: [t1]};
        W._EventStreamSubscription$(window, "keyup", H.functionTypeCheck(new T.Empirical_loadEvents_closure5(this), t2), false, t1);
        W._EventStreamSubscription$(window, "keydown", H.functionTypeCheck(new T.Empirical_loadEvents_closure6(this), t2), false, t1);
        t1 = $.$get$canvas();
        t1.toString;
        t2 = W.MouseEvent;
        W._EventStreamSubscription$(t1, "click", H.functionTypeCheck(new T.Empirical_loadEvents_closure7(this), {func: 1, ret: -1, args: [t2]}), false, t2);
        t2 = W.Event;
        W._EventStreamSubscription$(window, "resize", H.functionTypeCheck(new T.Empirical_loadEvents_closure8(this), {func: 1, ret: -1, args: [t2]}), false, t2);
      },
      exitMenu$0: function() {
        switch (J.get$runtimeType$($.currentMenu)) {
          case C.Type_MainMenu_mbs:
            window.history.back();
            return;
          case C.Type_PauseMenu_6Re:
            this.started = false;
            C.JSArray_methods.set$length(this.station.tribes, 0);
            var t1 = T.getMenu(C.MainMenu_ohJ);
            $.currentMenu.hide$0();
            $.currentMenu = t1;
            t1.show$0(0);
            return;
          case C.Type_OptionsMenu_B8J:
          default:
            t1 = T.getMenu(C.MainMenu_ohJ);
            $.currentMenu.hide$0();
            $.currentMenu = t1;
      ...
      _keyInput$0: function() {
        var t1 = this.keys;
        if (t1[80])
          this._pause$0();
        else if (t1[82] && !this.paused) {
          t1 = this.station;
          C.JSArray_methods.set$length(t1.tribes, 0);
          t1.start$0(0);
        }
      },
      _tick$1: [function(time) {
        ...
        if (!this.paused && this.started) {
          ...
          t2 = this.keys;
          t3 = t1.player;
          t3.super$Controllable$input(t2);
          if (t2[32] && t3.shieldPower < -50)
            t3.shieldPower = 40;
          t1.tick$0();
        }
        C.Window_methods.requestAnimationFrame$1(window, this.get$_tick());
      }, "call$1", "get$_tick", 4, 0, 28],
      _draw$0: function() {
        var t1, t2;
        t1 = $.$get$context();
        t1.fillStyle = "black";
      ...
      _pause$0: function() {
        ...
        this.paused = t1;
        if (t1 && this.started) {
          t1 = T.getMenu(C.PauseMenu_Fou);
          $.currentMenu.hide$0();
          $.currentMenu = t1;
          t1.show$0(0);
        } else {
          t1 = T.getMenu(C.GameMenu_Tny);
          $.currentMenu.hide$0();
          $.currentMenu = t1;
          t1.show$0(0);
        }
    ...
    Empirical_loadEvents_closure: {
      "^": "Closure:2;$this",
      call$1: function($event) {
        var t1, t2;
        H.interceptedTypeCheck($event, "$isMouseEvent");
        t1 = this.$this;
        t2 = T.getMenu(C.GameMenu_Tny);
        $.currentMenu.hide$0();
        $.currentMenu = t2;
        t2.show$0(0);
        t1.paused = false;
        t1.started = true;
        t1.station.start$0(0);
        return;
      }
    },
    Empirical_loadEvents_closure0: {
      "^": "Closure:3;$this",
      call$1: function(element) {
        var t1, t2;
        t1 = J.get$onClick$x(H.interceptedTypeCheck(element, "$isElement"));
        t2 = H.getTypeArgumentByIndex(t1, 0);
        return W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new T.Empirical_loadEvents__closure1(this.$this), {func: 1, ret: -1, args: [t2]}), false, t2);
      }
    },
    Empirical_loadEvents__closure1: {
      "^": "Closure:2;$this",
      call$1: function($event) {
        H.interceptedTypeCheck($event, "$isMouseEvent");
        return this.$this._pause$0();
      }
    },
    Empirical_loadEvents_closure1: {
      "^": "Closure:3;",
      call$1: function(element) {
        var t1, t2;
        t1 = J.get$onClick$x(H.interceptedTypeCheck(element, "$isElement"));
        t2 = H.getTypeArgumentByIndex(t1, 0);
        return W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new T.Empirical_loadEvents__closure0(), {func: 1, ret: -1, args: [t2]}), false, t2);
      }
    },
    Empirical_loadEvents__closure0: {
      "^": "Closure:2;",
      call$1: function($event) {
        H.interceptedTypeCheck($event, "$isMouseEvent");
        $.currentMenu.hide$0();
        $.currentMenu = C.OptionsMenu_Kdl;
        C.OptionsMenu_Kdl.show$0(0);
        return;
      }
    },
    Empirical_loadEvents_closure2: {
      "^": "Closure:3;$this",
      call$1: function(element) {
        var t1, t2;
        t1 = J.get$onClick$x(H.interceptedTypeCheck(element, "$isElement"));
        t2 = H.getTypeArgumentByIndex(t1, 0);
        return W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new T.Empirical_loadEvents__closure(this.$this), {func: 1, ret: -1, args: [t2]}), false, t2);
      }
    },
    Empirical_loadEvents__closure: {
      "^": "Closure:2;$this",
      call$1: function($event) {
        H.interceptedTypeCheck($event, "$isMouseEvent");
        return this.$this.exitMenu$0();
      }
    },
    Empirical_loadEvents_closure3: {
      "^": "Closure:4;$this,fullscreenToggle",
      call$1: function($event) {
        var t1;
        H.interceptedTypeCheck($event, "$isMouseEvent");
        t1 = H.interceptedTypeCast(this.fullscreenToggle, "$isInputElement");
        t1.disabled = !t1.disabled;
        $.MOBILE_MODE = !$.MOBILE_MODE;
        t1 = this.$this;
        T.resizeCanvas();
        t1.station.resize$0(0);
        t1._draw$0();
      }
    },
    Empirical_loadEvents_closure4: {
      "^": "Closure:4;$this,mobileToggle",
      call$1: function($event) {
        var t1;
        H.interceptedTypeCheck($event, "$isMouseEvent");
        t1 = H.interceptedTypeCast(this.mobileToggle, "$isInputElement");
        t1.disabled = !t1.disabled;
    ...
    Empirical_loadEvents_closure5: {
      ...
      call$1: function($event) {
        ...
        if (!t1.started)
          return;
        C.JSArray_methods.$indexSet(t1.keys, $event.keyCode, false);
        t1._keyInput$0();
      }
    },
    Empirical_loadEvents_closure6: {
      "^": "Closure:13;$this",
      call$1: function($event) {
        var t1;
        H.interceptedTypeCheck($event, "$isKeyboardEvent");
        ...
        if (!t1.started)
          return;
        C.JSArray_methods.$indexSet(t1.keys, $event.keyCode, true);
        t1._keyInput$0();
      }
    },
    Empirical_loadEvents_closure7: {
      "^": "Closure:4;$this",
      call$1: function($event) {
        var t1, t2;
        H.interceptedTypeCheck($event, "$isMouseEvent");
        t1 = this.$this;
        if (!t1.paused && t1.started) {
          t1 = $event.pageX;
          $event.pageY;
          t2 = $.$get$canvas();
          C.JSNumber_methods.round$0(t2.offsetLeft);
          C.JSNumber_methods.round$0(t2.scrollLeft);
          if (typeof t1 !== "number")
            return t1.$sub();
          t1 = $event.pageY;
          C.JSNumber_methods.round$0(t2.offsetTop);
          C.JSNumber_methods.round$0(t2.scrollTop);
          if (typeof t1 !== "number")
            return t1.$sub();
        }
      }
    },
    Empirical_loadEvents_closure8: {
      "^": "Closure:10;$this",
      call$1: function($event) {
        var t1 = this.$this;
        T.resizeCanvas();
    ...
    Menu: {
      ...
      create$0: function() {
        ...
        (t1 && C.BodyElement_methods).insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", '<div id="' + this.id + '" class="popup"> ' + this.content + " </div>", null, null);
        return;
      },
      hide$0: function() {
        var t1 = "#" + this.id;
    ...
    getMenu_closure: {
      "^": "Closure:5;",
      call$1: function(element) {
        return H.interceptedTypeCheck(element, "$isMenu") instanceof T.MainMenu;
      }
    },
    getMenu_closure0: {
      "^": "Closure:5;",
      call$1: function(element) {
        return H.interceptedTypeCheck(element, "$isMenu") instanceof T.PauseMenu;
      }
    },
    getMenu_closure1: {
      "^": "Closure:5;",
      call$1: function(element) {
        return H.interceptedTypeCheck(element, "$isMenu") instanceof T.GameMenu;
      }
    }
  }], ["entity", "../entity/entity.dart",, S, {
    "^": "",
    Drawable: {
      "^": "Object;"
    },
    Entity: {
      "^": "Object;x*,y*",
      stretch$2: function(scaleWidth, scaleHeight) {
        var t1 = this.get$x(this);
        if (typeof t1 !== "number")
          return t1.$mul();
        this.set$x(0, t1 * scaleWidth);
        t1 = this.get$y(this);
        if (typeof t1 !== "number")
          return t1.$mul();
        this.set$y(0, t1 * scaleHeight);
        this.width *= scaleWidth;
        this.height *= scaleHeight;
      },
      shrink$2: function(prevWidth, prevHeight) {
        var t1 = this.get$x(this);
        if (typeof t1 !== "number")
          return t1.$div();
        this.set$x(0, t1 / prevWidth);
        t1 = this.get$y(this);
        if (typeof t1 !== "number")
          return t1.$div();
        this.set$y(0, t1 / prevHeight);
        this.width /= prevWidth;
        this.height /= prevHeight;
      },
      resize$4: function(_, prevWidth, prevHeight, scaleWidth, scaleHeight) {
        this.shrink$2(prevWidth, prevHeight);
        this.stretch$2(scaleWidth, scaleHeight);
      },
      moveX$2$canExitBounds: function(distance, canExitBounds) {
        var t1, t2;
        t1 = this.get$x(this);
        if (typeof t1 !== "number")
          return t1.$add();
      ...
      moveX$1: function(distance) {
        return this.moveX$2$canExitBounds(distance, false);
      },
      moveY$2$canExitBounds: function(distance, canExitBounds) {
        var t1, t2;
        t1 = this.get$y(this);
        if (typeof t1 !== "number")
          return t1.$add();
        if (typeof distance !== "number")
          return H.iae(distance);
        this.set$y(0, t1 + distance);
        t1 = this.get$y(this);
        if (typeof t1 !== "number")
          return t1.$lt();
        if (!(t1 < 0)) {
          t1 = this.get$y(this);
          t2 = $.$get$canvas().height;
          if (typeof t1 !== "number")
            return t1.$gt();
          if (typeof t2 !== "number")
            return H.iae(t2);
      ...
      moveY$1: function(distance) {
        return this.moveY$2$canExitBounds(distance, false);
      },
      inProximity$2: function(target, radius) {
        var t1, t2;
        if (this !== target) {
          ...
          if (typeof t2 !== "number")
            return H.iae(t2);
          if (Math.abs(t1 - t2) < radius) {
            t1 = target.get$y(target);
            t2 = this.get$y(this);
            if (typeof t1 !== "number")
              return t1.$sub();
            if (typeof t2 !== "number")
              return H.iae(t2);
            t2 = Math.abs(t1 - t2) < radius;
            t1 = t2;
          } else
            t1 = false;
        } else
      ...
      closestTarget$1: function(entities) {
        var currentClosest, totalDistance, t1, currentClosest0, t2, t3, t4, t5, entityDistance;
        H.assertSubtype(entities, "$isList", [S.Entity], "$asList");
        if (entities.length <= 0)
          return;
        currentClosest = C.JSArray_methods.get$first(entities);
        totalDistance = this.totalDistanceTo$1(C.JSArray_methods.get$first(entities));
        for (t1 = H.SubListIterable$(entities, 1, null, H.getTypeArgumentByIndex(entities, 0)), t1 = new H.ListIterator(t1, t1.get$length(t1), 0, [H.getTypeArgumentByIndex(t1, 0)]); t1.moveNext$0();) {
          currentClosest0 = t1.__internal$_current;
          if (this === currentClosest0)
            continue;
          t2 = currentClosest0.get$x(currentClosest0);
          t3 = this.get$x(this);
          if (typeof t2 !== "number")
            return t2.$sub();
          if (typeof t3 !== "number")
            return H.iae(t3);
          t4 = currentClosest0.get$y(currentClosest0);
          t5 = this.get$y(this);
          if (typeof t4 !== "number")
            return t4.$sub();
          if (typeof t5 !== "number")
            return H.iae(t5);
          entityDistance = Math.abs(t2 - t3) + Math.abs(t4 - t5);
          if (entityDistance < totalDistance) {
            totalDistance = entityDistance;
            currentClosest = currentClosest0;
          }
        }
        return currentClosest;
      },
      totalDistanceTo$1: function(entity) {
        var t1, t2, t3, t4;
        H.interceptedTypeCheck(entity, "$isEntity");
        t1 = entity.get$x(entity);
        t2 = this.get$x(this);
        if (typeof t1 !== "number")
          return t1.$sub();
        if (typeof t2 !== "number")
          return H.iae(t2);
        t3 = entity.get$y(entity);
        t4 = this.get$y(this);
        if (typeof t3 !== "number")
          return t3.$sub();
        if (typeof t4 !== "number")
      ...
      draw$0: ["super$Entity$draw", function() {
        $.$get$context().drawImage(this.sprite, this.get$x(this), this.get$y(this), this.width, this.height);
      }],
      $isDrawable: 1
    },
    Living: {
      "^": "Object;health:Living_health@,maxHealth:Living_maxHealth@",
      hurt$2: function(damage, attacker) {
        var t1;
        this.set$health(this.get$health() - damage);
        if (this.get$health() < 0) {
          this.super$LivingEntity$death(attacker);
          t1 = this.Living_murderer;
          if (t1 instanceof K.Drone)
            t1.engorge$2(this, t1);
          this.set$health(0);
        }
      },
      hurt$1: function(damage) {
        return this.hurt$2(damage, null);
      },
      healBy$1: function(healthIncrease) {
        this.set$health(this.get$health() + healthIncrease);
        this.capHealth$0();
      },
      vitalize$1: function(vitality) {
        this.set$maxHealth(this.get$maxHealth() + vitality);
      },
      capHealth$0: function() {
        if (this.get$health() > this.get$maxHealth())
          this.set$health(this.get$maxHealth());
      }
    },
    LivingEntity: {
      "^": "_LivingEntity_Entity_Living_Moving;",
      death$1$murderr: ["super$LivingEntity$death", function(murderr) {
        this.Living_murderer = murderr;
        this.dead = true;
      }]
    },
    Moving: {
      "^": "Object;speed:Moving_speed@"
    },
    _LivingEntity_Entity_Living: {
      "^": "Entity+Living;health:Living_health@,maxHealth:Living_maxHealth@"
    },
    _LivingEntity_Entity_Living_Moving: {
      "^": "_LivingEntity_Entity_Living+Moving;speed:Moving_speed@"
    }
  }], ["lunaris", "lunaris.dart",, K, {
    "^": "",
    Banner_bannerToColor: function(banner) {
      switch (banner) {
        case 54:
          return "blue";
        case 55:
    ...
    Banner_getFreeBanner: function() {
      var t1 = $.$get$Banner_tribeBanners();
      if (t1.length <= 0) {
        t1 = H.setRuntimeTypeInfo([54, 55, 56, 57, 58, 59, 60], [P.int]);
        $.Banner_tribeBanners = t1;
      }
    ...
    main: function() {
      ...
      e.src = "sprite\\player.gif";
      t1 = new K.Player(3, -50, null, null, null, 200, 200, 59, false, "green", 1, 1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
      t1.randomCoordinates$0();
      t1.healthColor = K.Banner_bannerToColor(59);
      t1.SuperTribal$2(59, "player.gif");
      t1.Controllable_x = -t1.width;
      t1.Controllable_y = -t1.height;
      t1 = new K.Lunaris(new K.Station(t1, H.setRuntimeTypeInfo([], [K.HeldTribe]), 1, 1), false, false, P.List_List$filled(250, false, false, P.bool));
      t1.Empirical$0();
      return t1;
    },
    Controllable: {
      "^": "Object;x:Controllable_x*,y:Controllable_y*,speed:Controllable_speed@",
      input$1: ["super$Controllable$input", function(keys) {
        var t1, t2;
        if (keys[87] || keys[38]) {
          t1 = this.Controllable_y;
          t2 = this.Controllable_speed;
          if (typeof t1 !== "number")
            return t1.$sub();
          if (typeof t2 !== "number")
            return H.iae(t2);
          this.Controllable_y = t1 - t2;
        }
        if (keys[65] || keys[37]) {
          t1 = this.Controllable_x;
          t2 = this.Controllable_speed;
          if (typeof t1 !== "number")
            return t1.$sub();
          if (typeof t2 !== "number")
            return H.iae(t2);
          this.Controllable_x = t1 - t2;
        }
        if (keys[83] || keys[40]) {
          t1 = this.Controllable_y;
          t2 = this.Controllable_speed;
    ...
    Drone: {
      "^": "LivingEntity;shieldCharged<,healthColor,damage,Moving_speed,Moving_speedX,Moving_speedY,Living_health,Living_maxHealth,Living_murderer,sprite,x,y,width,height,dead",
      get$radius: function() {
        return this.width * 1.5;
      },
      canAttack$1: function(entity) {
        return true;
      },
      tick$1: ["super$Drone$tick", function(drones) {
        H.assertSubtype(drones, "$isList", [K.Drone], "$asList");
        this.move$0();
        this.shieldAttack$1(drones);
      }],
      shieldAttack$1: function(drones) {
        var t1, t2, t3, _i, targetDrone, t4;
        H.assertSubtype(drones, "$isList", [K.Drone], "$asList");
        if (!this.get$shieldCharged())
          return;
        t1 = H.setRuntimeTypeInfo(drones.slice(0), [H.getTypeArgumentByIndex(drones, 0)]);
        t2 = t1.length;
        t3 = this.damage;
        _i = 0;
        for (; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          targetDrone = t1[_i];
          if (!this.canAttack$1(targetDrone))
            continue;
          if (this.inProximity$2(targetDrone, this.get$radius())) {
            targetDrone.set$health(targetDrone.get$health() - t3);
            if (targetDrone.get$health() < 0) {
              targetDrone.super$LivingEntity$death(this);
              t4 = targetDrone.Living_murderer;
              if (t4 instanceof K.Drone)
                t4.engorge$2(targetDrone, t4);
              targetDrone.set$health(0);
            }
          }
        }
      },
      randomCoordinates$0: function() {
        var t1, t2;
        t1 = $.$get$random();
        t2 = $.$get$canvas();
        this.set$x(0, t1.nextInt$1(J.toInt$0$n(t2.width)));
        this.set$y(0, t1.nextInt$1(J.toInt$0$n(t2.height)));
      },
      engorge$2: function(defeated, murderer) {
        var t1, t2;
        this.vitalize$1(20);
        this.healBy$1(20);
        t1 = murderer.width;
        if (t1 > 60)
          return;
        murderer.width = t1 + defeated.width / 15;
        murderer.height = murderer.height + defeated.height / 15;
        t1 = murderer.get$speed();
        t2 = defeated.get$speed();
        if (typeof t2 !== "number")
          return t2.$div();
        if (typeof t1 !== "number")
          return t1.$add();
        murderer.set$speed(t1 + t2 / 7);
      },
      draw$0: ["super$Drone$draw", function() {
        var t1, t2, t3;
        this.super$Entity$draw();
        t1 = $.$get$context();
        t1.fillStyle = "red";
        t2 = this.get$x(this);
        t3 = this.get$y(this);
        if (typeof t3 !== "number")
          return t3.$sub();
        t1.fillRect(t2, t3 - 20, this.width, 6);
        t1.fillStyle = this.healthColor;
        t2 = this.get$x(this);
        t3 = this.get$y(this);
        if (typeof t3 !== "number")
          return t3.$sub();
        t1.fillRect(t2, t3 - 20, this.get$health() / this.get$maxHealth() * this.width, 6);
        this.drawShield$0();
      }],
      drawShield$0: function() {
        var t1, t2, t3, t4, t5;
        if (this.get$shieldCharged()) {
          t1 = $.$get$context();
          ...
          if (typeof t4 !== "number")
            return t4.$add();
          t1.arc(t2 + t3 / 2, t4 + t5 / 2, this.get$radius(), 0, 6.283185307179586, false);
          t1.stroke();
        }
      },
      move$0: ["super$Drone$move", function() {
        switch ($.$get$random().nextInt$1(5)) {
          case 0:
            var t1 = this.get$speed();
            if (typeof t1 !== "number")
              return t1.$negate();
            this.moveY$1(-t1);
            break;
          case 1:
            ...
            break;
          case 2:
            this.moveY$1(this.get$speed());
            break;
          case 3:
            this.moveX$1(this.get$speed());
            break;
          case 4:
            this.shieldCharge$0();
            break;
      ...
      shieldCharge$0: function() {
        if ($.$get$random().nextInt$1(100) === 0)
          this.shieldCharged = !this.get$shieldCharged();
      }
    },
    DroneSpawner: {
      "^": "Entity;",
      DroneSpawner$2: function(zX, zY) {
        this.x = zX;
        this.y = zY;
        this.startX = zX;
        this.startY = zY;
    ...
    TribeSpawner: {
      "^": "DroneSpawner;banner,0startX,0startY,sprite,x,y,width,height,dead",
      getSuperDrone$0: function() {
        var t1, e, t2;
        switch ($.$get$random().nextInt$1(4)) {
          case 0:
            t1 = this.banner;
            e = document.createElement("img");
            e.src = "sprite\\gravity_drone.gif";
            t2 = new K.GravityTribal(200, 200, t1, false, "green", 1, 1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
            t2.randomCoordinates$0();
            t2.healthColor = K.Banner_bannerToColor(t1);
            t2.SuperTribal$2(t1, "gravity_drone.gif");
            return t2;
          case 1:
            t1 = this.banner;
            e = document.createElement("img");
            e.src = "sprite\\cleaver_drone.gif";
            t2 = new K.TargetTribal(200, 200, t1, false, "green", 1, 1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
            t2.randomCoordinates$0();
            t2.healthColor = K.Banner_bannerToColor(t1);
            t2.SuperTribal$2(t1, "cleaver_drone.gif");
            return t2;
          case 2:
            t1 = this.banner;
            e = document.createElement("img");
            e.src = "sprite\\vampire_drone.gif";
            t2 = new K.VampireTribal(200, 200, t1, false, "green", 1, 1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
            t2.randomCoordinates$0();
            t2.healthColor = K.Banner_bannerToColor(t1);
            t2.SuperTribal$2(t1, "vampire_drone.gif");
            return t2;
          case 3:
            t1 = this.banner;
            e = document.createElement("img");
            e.src = "sprite\\regen_drone.gif";
            t2 = new K.RegenTribal(200, 200, t1, false, "green", 1, 1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
            t2.randomCoordinates$0();
            t2.healthColor = K.Banner_bannerToColor(t1);
            t2.SuperTribal$2(t1, "regen_drone.gif");
            return t2;
        }
      },
      getDroneToSpawn$0: function() {
        var t1, e, result;
        t1 = $.$get$random();
        if (t1.nextInt$1(30) === 0)
          return this.getSuperDrone$0();
        else {
          switch (t1.nextInt$1(1)) {
            case 0:
              t1 = this.banner;
              e = document.createElement("img");
              e.src = "sprite\\round_drone.gif";
              result = new K.TribeDrone(t1, false, "green", 1, 1.4, 0, 0, 100, 100, null, e, 10, 10, 20, 20, false);
              result.randomCoordinates$0();
              result.healthColor = K.Banner_bannerToColor(t1);
              break;
            default:
              result = null;
          }
    ...
    GravityTribal: {
      "^": "SuperTribal;SuperTribal_health,SuperTribal_maxHealth,banner,shieldCharged,healthColor,damage,Moving_speed,Moving_speedX,Moving_speedY,Living_health,Living_maxHealth,Living_murderer,sprite,x,y,width,height,dead",
      drawShield$0: function() {
        var t1, t2, t3, t4, t5;
        if (this.shieldCharged && this.SuperTribal_health > 10) {
          t1 = $.$get$context();
          t1.strokeStyle = "blue";
        } else {
          t1 = $.$get$context();
        ...
        if (typeof t4 !== "number")
          return t4.$add();
        t1.arc(t2 + t3 / 2, t4 + t5 / 2, t3 * 1.8 * 1.5, 0, 6.283185307179586, false);
        t1.stroke();
        t1.strokeStyle = "white";
        t1.beginPath();
        t3 = this.x;
        ...
        if (typeof t4 !== "number")
          return t4.$add();
        t1.arc(t3 + t5 / 2, t4 + t2 / 2, t5 * 1.8, 0, 6.283185307179586, false);
        t1.stroke();
      },
      attack$1: function(drones) {
        H.assertSubtype(drones, "$isList", [K.Drone], "$asList");
        this.super$SuperTribal$attack(drones);
        if (this.shieldCharged && this.SuperTribal_health > 10)
          this.gravityPull$1(drones);
        else
          this.gravityPush$1(drones);
      },
      gravityPush$1: function(drones) {
        var t1;
        H.assertSubtype(drones, "$isList", [S.Entity], "$asList");
        t1 = H.getTypeArgumentByIndex(drones, 0);
        new H.WhereIterable(drones, H.functionTypeCheck(new K.GravityTribal_gravityPush_closure(this), {func: 1, ret: P.bool, args: [t1]}), [t1]).forEach$1(0, new K.GravityTribal_gravityPush_closure0(this));
        return false;
      },
      gravityPull$1: function(entities) {
        var t1;
        H.assertSubtype(entities, "$isList", [S.Entity], "$asList");
        t1 = H.getTypeArgumentByIndex(entities, 0);
        new H.WhereIterable(entities, H.functionTypeCheck(new K.GravityTribal_gravityPull_closure(this), {func: 1, ret: P.bool, args: [t1]}), [t1]).forEach$1(0, new K.GravityTribal_gravityPull_closure0(this));
        return false;
      }
    },
    GravityTribal_gravityPush_closure: {
      "^": "Closure:14;$this",
      call$1: function(entity) {
        var t1;
        H.interceptedTypeCheck(entity, "$isEntity");
        t1 = this.$this;
        return t1.inProximity$2(entity, t1.width * 1.8 * 1.5) && t1.canAttack$1(H.interceptedTypeCheck(entity, "$isLivingEntity"));
      }
    },
    GravityTribal_gravityPush_closure0: {
      "^": "Closure:15;$this",
      call$1: function(entity) {
        var t1, t2, t3, t4;
        H.interceptedTypeCheck(entity, "$isEntity");
    ...
    GravityTribal_gravityPull_closure: {
      "^": "Closure:14;$this",
      call$1: function(entity) {
        var t1;
        H.interceptedTypeCheck(entity, "$isEntity");
    ...
    GravityTribal_gravityPull_closure0: {
      "^": "Closure:15;$this",
      call$1: function(entity) {
        var t1, t2, t3, t4;
        H.interceptedTypeCheck(entity, "$isEntity");
    ...
    RegenTribal: {
      ...
      attack$1: function(drones) {
        ...
        if (this.shieldCharged) {
          this.healBy$1(1);
          t1 = H.getTypeArgumentByIndex(drones, 0);
          C.JSArray_methods.forEach$1(P.List_List$from(new H.WhereIterable(drones, H.functionTypeCheck(new K.RegenTribal_attack_closure(this), {func: 1, ret: P.bool, args: [t1]}), [t1]), true, t1), new K.RegenTribal_attack_closure0());
        }
      }
    },
    RegenTribal_attack_closure: {
      "^": "Closure:16;$this",
      call$1: function(drone) {
        var t1, t2;
        H.interceptedTypeCheck(drone, "$isDrone");
        t1 = this.$this;
        if (t1.inProximity$2(drone, t1.width * 1.8))
          if (drone instanceof K.TribeDrone) {
            t2 = drone.banner;
            t1 = t1.banner;
    ...
    RegenTribal_attack_closure0: {
      "^": "Closure:29;",
      call$1: function(drone) {
        return H.interceptedTypeCheck(drone, "$isDrone").healBy$1(1);
      }
    },
    SuperTribal: {
      "^": "TribeDrone;health:SuperTribal_health@,maxHealth:SuperTribal_maxHealth@",
      get$radius: function() {
        return this.width * 1.8;
      },
      SuperTribal$2: function(banner, sprite) {
        this.width *= 1.4;
        this.height *= 1.4;
      },
      tick$1: function(drones) {
        H.assertSubtype(drones, "$isList", [K.Drone], "$asList");
        this.super$Drone$tick(drones);
        this.attack$1(drones);
      },
      attack$1: ["super$SuperTribal$attack", function(drones) {
        H.assertSubtype(drones, "$isList", [K.Drone], "$asList");
        this.shieldCharge$0();
      }],
      vitalize$1: function(vitality) {
    ...
    TargetTribal: {
      ...
      attack$1: function(drones) {
        ...
        if (this.shieldCharged) {
          t1 = H.getTypeArgumentByIndex(drones, 0);
          this.moveTowards$1(H.interceptedTypeCheck(this.closestTarget$1(P.List_List$from(new H.WhereIterable(drones, H.functionTypeCheck(new K.TargetTribal_attack_closure(this), {func: 1, ret: P.bool, args: [t1]}), [t1]), true, t1)), "$isLivingEntity"));
        } else
          this.super$Drone$move();
      },
      move$0: function() {
      },
      moveTowards$1: function(target) {
        var t1, t2, t3, t4;
        if (target == null)
          return;
        if (this.inProximity$2(target, this.width * 1.8 - 3))
          this.super$Drone$move();
        else {
          t1 = target.get$x(target);
          t2 = this.x;
    ...
    TargetTribal_attack_closure: {
      "^": "Closure:16;$this",
      call$1: function(drone) {
        var t1;
        H.interceptedTypeCheck(drone, "$isDrone");
        if (drone instanceof K.TribeDrone)
          t1 = this.$this.canAttack$1(drone);
        else
          t1 = true;
        return t1;
      }
    ...
    VampireTribal: {
      ...
      drawShield$0: function() {
        ...
        if (typeof t4 !== "number")
          return t4.$add();
        t1.arc(t2 + t3 / 2, t4 + t5 / 2, t3 * 1.8 * 1.02, 0, 6.283185307179586, false);
        t1.stroke();
        t1.strokeStyle = "white";
        t1.beginPath();
        t3 = this.x;
      ...
      shieldAttack$1: function(drones) {
        var t1, t2, _i, targetDrone, t3, t4;
        H.assertSubtype(drones, "$isList", [K.Drone], "$asList");
        if (this.shieldCharged) {
          t1 = H.setRuntimeTypeInfo(drones.slice(0), [H.getTypeArgumentByIndex(drones, 0)]);
          t2 = t1.length;
          ...
          for (; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
            targetDrone = t1[_i];
            if (this.canAttack$1(targetDrone) && this.inProximity$2(targetDrone, this.width * 1.8)) {
              targetDrone.set$health(targetDrone.get$health() - 1);
              if (targetDrone.get$health() < 0) {
                targetDrone.super$LivingEntity$death(this);
                t3 = targetDrone.Living_murderer;
                if (t3 instanceof K.Drone)
                  t3.engorge$2(targetDrone, t3);
                targetDrone.set$health(0);
              }
              t3 = ++this.SuperTribal_health;
              t4 = this.SuperTribal_maxHealth;
              if (t3 > t4)
                this.SuperTribal_health = t4;
            } else if (this.SuperTribal_health <= 60 && this.inProximity$2(targetDrone, this.width * 1.8)) {
              targetDrone.set$health(targetDrone.get$health() - 1);
              if (targetDrone.get$health() < 0) {
                targetDrone.super$LivingEntity$death(this);
                t3 = targetDrone.Living_murderer;
      ...
      vitalize$1: function(vitality) {
        this.healBy$1(vitality / 2);
      }
    },
    TribeDrone: {
      "^": "Drone;banner,shieldCharged,healthColor,damage,Moving_speed,Moving_speedX,Moving_speedY,Living_health,Living_maxHealth,Living_murderer,sprite,x,y,width,height,dead",
      canAttack$1: function(entity) {
        var t1, t2;
        if (entity instanceof K.TribeDrone) {
          t1 = entity.banner;
          t2 = this.banner;
          t2 = t1 == null ? t2 == null : t1 === t2;
          t1 = t2;
    ...
    HeldTribe: {
      "^": "Tribe;members,masterBanner,shouldDrawHealthBar,0_spawner,0banner,hostility,leadership,hasCultured,0territory",
      tick$1: function(drones) {
        var t1, t2;
        H.assertSubtype(drones, "$isList", [S.LivingEntity], "$asList");
        t1 = this.members;
        t2 = H.functionTypeCheck(new K.HeldTribe_tick_closure(drones), {func: 1, ret: P.bool, args: [H.getTypeArgumentByIndex(t1, 0)]});
        C.JSArray_methods._removeWhere$2(t1, t2, true);
        if (drones.length < 153 && $.$get$random().nextInt$1(40) === 0)
          this.growHeld$1$spawnCount(7);
        if (this.hasCultured) {
          if (t1.length <= 0)
            this.leadership = 68;
        } else
          this.hasCultured = true;
      },
      growHeld$1$spawnCount: function(spawnCount) {
        var t1, t2, x, t3, t4, t5;
        switch (this.leadership) {
          case 68:
            break;
          case 69:
            C.JSArray_methods.set$length(this.members, 0);
            break;
          case 64:
          default:
            for (t1 = this.members, t2 = [K.Drone], x = 0; x <= spawnCount; ++x) {
              t3 = this._spawner;
              t3.toString;
              H.assertSubtype(t1, "$isList", t2, "$asList");
              t4 = t3.x;
              t5 = t3.y;
              t3 = t3.getDroneToSpawn$0();
              t3.set$x(0, t4);
              t3.set$y(0, t5);
      ...
      stretch$2: function(scaleWidth, scaleHeight) {
        C.JSArray_methods.forEach$1(this.members, new K.HeldTribe_stretch_closure(scaleWidth, scaleHeight));
      },
      shrink$2: function(prevWidth, prevHeight) {
        C.JSArray_methods.forEach$1(this.members, new K.HeldTribe_shrink_closure(prevWidth, prevHeight));
      },
      resize$4: function(_, prevWidth, prevHeight, scaleWidth, scaleHeight) {
        this.shrink$2(prevWidth, prevHeight);
        this.stretch$2(scaleWidth, scaleHeight);
      ...
      draw$0: function() {
        var t1, t2;
        C.JSArray_methods.forEach$1(this.members, new K.HeldTribe_draw_closure());
        switch (this.leadership) {
          case 66:
          case 68:
            t1 = $.$get$context();
            t1.fillStyle = K.Banner_bannerToColor(this.banner);
            t2 = this.territory;
            t1.fillRect(t2.left, t2.top, t2.width, t2.height);
            break;
          default:
            t1 = $.$get$context();
            t1.strokeStyle = K.Banner_bannerToColor(this.banner);
            t2 = this.territory;
            t1.strokeRect(t2.left, t2.top, t2.width, t2.height);
        }
      },
      getCenterPoint$0: function() {
        var t1, t2, t3;
        t1 = this.territory;
        t2 = t1.left;
        t3 = t1.top;
        return new P.Point(t2 + t1.width / 2, t3 + t1.height / 2, [P.num]);
      },
      territoryIntrusive$2: function(tribes, newTerritory) {
        var t1, t2, t3, t4, t5, t6, _i, t7, t8;
        H.assertSubtype(tribes, "$isList", [K.Tribe], "$asList");
        t1 = [P.num];
        H.assertSubtype(newTerritory, "$isRectangle", t1, "$asRectangle");
        for (t2 = tribes.length, t3 = newTerritory.left, t4 = t3 + newTerritory.width, t5 = newTerritory.top, t6 = t5 + newTerritory.height, _i = 0; _i < t2; ++_i) {
          t7 = H.assertSubtype(tribes[_i].territory, "$isRectangle", t1, "$asRectangle");
          t8 = t7.left;
          if (t3 <= t8 + t7.width)
            if (t8 <= t4) {
              t8 = t7.top;
              t7 = t5 <= t8 + t7.height && t8 <= t6;
            } else
              t7 = false;
          else
            t7 = false;
      ...
      getRealTerritory$1: function(tribes) {
        var t1, t2, t3, t4, t5, t6, newTerritory;
        t1 = $.$get$canvas();
        t2 = t1.width;
        if (typeof t2 !== "number")
          return H.iae(t2);
        ...
        if (typeof t3 !== "number")
          return H.iae(t3);
        t4 = this.getCoordForTerritory$0();
        t5 = t1.width;
        if (typeof t5 !== "number")
          return H.iae(t5);
        t6 = this.getCoordForTerritory$0();
        t1 = t1.height;
        if (typeof t1 !== "number")
          return H.iae(t1);
        newTerritory = P.Rectangle$(t4 * t5, t6 * t1, 0.1 * t2, 0.1 * t3, P.num);
        if (this.territoryIntrusive$2(H.assertSubtype(tribes, "$isList", [K.Tribe], "$asList"), newTerritory))
          return this.getRealTerritory$1(tribes);
        else
          return newTerritory;
      },
      getCoordForTerritory$0: function() {
        return 0.1 * $.$get$random().nextInt$1(10);
      },
      $isDrawable: 1
    },
    HeldTribe_tick_closure: {
      "^": "Closure:30;drones",
      call$1: function(member) {
        H.interceptedTypeCheck(member, "$isTribeDrone");
        member.tick$1(H.assertSubtype(this.drones, "$isList", [K.Drone], "$asList"));
        return member.dead;
      }
    },
    HeldTribe_stretch_closure: {
      "^": "Closure:6;scaleWidth,scaleHeight",
      call$1: function(member) {
        return H.interceptedTypeCheck(member, "$isTribeDrone").stretch$2(this.scaleWidth, this.scaleHeight);
      }
    },
    HeldTribe_shrink_closure: {
      "^": "Closure:6;prevWidth,prevHeight",
      call$1: function(member) {
        return H.interceptedTypeCheck(member, "$isTribeDrone").shrink$2(this.prevWidth, this.prevHeight);
      }
    },
    HeldTribe_draw_closure: {
      "^": "Closure:6;",
      call$1: function(member) {
        return H.interceptedTypeCheck(member, "$isTribeDrone").draw$0();
      }
    },
    Player: {
      "^": "_Player_SuperTribal_Controllable;lives,shieldPower,Controllable_x,Controllable_y,Controllable_speed,SuperTribal_health,SuperTribal_maxHealth,banner,shieldCharged,healthColor,damage,Moving_speed,Moving_speedX,Moving_speedY,Living_health,Living_maxHealth,Living_murderer,sprite,x,y,width,height,dead",
      get$shieldCharged: function() {
        return this.shieldPower > 0;
      },
      get$radius: function() {
        var t1 = this.width;
        return t1 * (this.shieldPower / 20) + t1 / 5;
      },
      attack$2$spawners: function(drones, spawners) {
        this.super$SuperTribal$attack(H.assertSubtype(drones, "$isList", [K.Drone], "$asList"));
        if (this.shieldPower <= 0)
          return;
      },
      attack$1: function(drones) {
        return this.attack$2$spawners(drones, null);
      },
      draw$0: function() {
        var t1, t2, t3, cooldown;
        this.super$Drone$draw();
        t1 = $.$get$context();
        t1.fillStyle = "grey";
        t2 = this.Controllable_x;
        t3 = this.Controllable_y;
        if (typeof t3 !== "number")
          return t3.$sub();
        t1.fillRect(t2, t3 - 30, this.width, 10);
        t1.fillStyle = "orange";
        t2 = this.shieldPower;
        if (t2 < 0) {
          cooldown = Math.abs(t2) / 50;
          if (cooldown > 1)
            cooldown = 1;
          t2 = this.Controllable_x;
          t3 = this.Controllable_y;
          if (typeof t3 !== "number")
            return t3.$sub();
          t1.fillRect(t2, t3 - 30, cooldown * this.width, 10);
        }
        this.drawShield$0();
      },
      drawShield$0: function() {
    ...
    Station: {
      "^": "Object;player,tribes,0initialWidth,0initialHeight,scaleWidth,scaleHeight",
      get$drones: function() {
        var allDrones, t1, t2, _i;
        allDrones = H.setRuntimeTypeInfo([], [K.Drone]);
        for (t1 = this.tribes, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          C.JSArray_methods.addAll$1(allDrones, t1[_i].members);
        return allDrones;
      },
      get$drawables: function() {
        var drawables = H.setRuntimeTypeInfo([], [S.Drawable]);
        C.JSArray_methods.addAll$1(drawables, this.tribes);
        C.JSArray_methods.add$1(drawables, this.player);
        return drawables;
      },
      resize$0: function(_) {
        var t1, t2, prevWidth, prevHeight, t3, _i;
        t1 = this.initialWidth;
        if (t1 == null || this.initialHeight == null) {
          t1 = $.$get$canvas();
          t2 = t1.width;
          this.initialWidth = t2;
          this.initialHeight = t1.height;
          t1 = t2;
        }
        prevWidth = this.scaleWidth;
        prevHeight = this.scaleHeight;
        t2 = $.$get$canvas();
        t3 = t2.width;
        if (typeof t3 !== "number")
          return t3.$div();
        if (typeof t1 !== "number")
          return H.iae(t1);
        this.scaleWidth = t3 / t1;
        t2 = t2.height;
        t1 = this.initialHeight;
        if (typeof t2 !== "number")
          return t2.$div();
        if (typeof t1 !== "number")
          return H.iae(t1);
        this.scaleHeight = t2 / t1;
        for (t1 = this.get$drawables(), t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          J.resize$4$x(t1[_i], prevWidth, prevHeight, this.scaleWidth, this.scaleHeight);
      },
      start$0: function(_) {
        var t1, t2, t3;
        t1 = this.player;
        t1.SuperTribal_health = t1.SuperTribal_maxHealth;
        t1.capHealth$0();
        t1.Controllable_speed = 1.4;
        t2 = $.$get$canvas();
        t3 = t2.width;
        if (typeof t3 !== "number")
          return t3.$div();
        t1.Controllable_x = t3 / 2 - t1.width / 2;
        t2 = t2.height;
        if (typeof t2 !== "number")
          return t2.$div();
        t1.Controllable_y = t2 / 2 - t1.height / 2;
        this.setupTribes$0();
      },
      setupTribes$0: function() {
        var t1, t2, t3, x, t4, t5, t6, t7, e;
        for (t1 = this.tribes, t2 = [K.TribeDrone], t3 = [P.int], x = 0; x < 6; ++x) {
          t4 = new K.HeldTribe(H.setRuntimeTypeInfo([], t2), 59, false, 59, 64, false);
          t4.Tribe$1(t1);
          t4.territory = t4.getRealTerritory$1(t1);
          t5 = $.$get$Banner_tribeBanners();
          if (t5.length <= 0) {
            t5 = H.setRuntimeTypeInfo([54, 55, 56, 57, 58, 59, 60], t3);
            $.Banner_tribeBanners = t5;
          }
          t4.banner = C.JSArray_methods.removeAt$1(t5, 0);
          t5 = t4.getCenterPoint$0().x;
          t6 = t4.getCenterPoint$0().y;
          t7 = t4.banner;
          e = document.createElement("img");
          e.src = "sprite\\spawner.gif";
          t7 = new K.TribeSpawner(t7, e, 10, 10, 20, 20, false);
          t7.x = t5;
          t7.y = t6;
          t7.startX = t5;
          t7.startY = t6;
          t4._spawner = t7;
          t4.growHeld$1$spawnCount(1);
          C.JSArray_methods.add$1(t1, t4);
        }
      },
      draw$0: function() {
        C.JSArray_methods.forEach$1(this.get$drawables(), new K.Station_draw_closure());
      },
      tick$0: function() {
        C.JSArray_methods.forEach$1(this.tribes, new K.Station_tick_closure(this));
      }
    },
    Station_draw_closure: {
      "^": "Closure:31;",
      call$1: function(drawable) {
        return H.interceptedTypeCheck(drawable, "$isDrawable").draw$0();
      }
    },
    Station_tick_closure: {
      "^": "Closure:32;$this",
      call$1: function(tribe) {
        H.interceptedTypeCheck(tribe, "$isHeldTribe").tick$1(this.$this.get$drones());
      }
    },
    Tribe: {
      "^": "Object;",
      Tribe$1: function(tribes) {
        var t1, t2, t3, e;
        this.territory = this.getRealTerritory$1(tribes);
        this.banner = K.Banner_getFreeBanner();
        t1 = this.getCenterPoint$0();
        t2 = this.getCenterPoint$0();
        t3 = this.banner;
        e = document.createElement("img");
        e.src = "sprite\\spawner.gif";
        t3 = new K.TribeSpawner(t3, e, 10, 10, 20, 20, false);
        t3.DroneSpawner$2(t1.x, t2.y);
        this._spawner = t3;
      },
      draw$0: function() {
        var t1, t2;
    ...
    Lunaris: {
      "^": "Empirical;station,started,paused,keys"
    },
    _Player_SuperTribal_Controllable: {
      "^": "SuperTribal+Controllable;x:Controllable_x*,y:Controllable_y*,speed:Controllable_speed@"
    }
  }, 1]];
  ...
  J.resize$4$x = function(receiver, a0, a1, a2, a3) {
    return J.getInterceptor$x(receiver).resize$4(receiver, a0, a1, a2, a3);
  };
  ...
  C.GameMenu_Tny = new T.GameMenu("gamemenu", "");
...
;
  ...
  C.MainMenu_Jhy = new T.MainMenu("mainmenu", '<h1> Lunraris </h1>\n<a id="startbutton"> Start </a>\n<a id="optionsbutton"> Options </a>\n<a id="exitbutton"> Exit </a>\n');
  C.MainMenu_ohJ = new T.MainMenu("mainmenu", '<h1>Placeholder Game</h1>\n    <a id="startbutton">Start</a>\n    <a id="optionsbutton">Options</a>\n    <a id="exitbutton">Exit</a>');
  C.OptionsMenu_Kdl = new T.OptionsMenu("optionsmenu", '<h1>Options</h1>\n        <form>\n    <p id="label"> Mobile Canvas: </p> <input type="checkbox" name="mobiletoggle" id="mobiletoggle" value="On">\n    <p id="label"> Fullscreen Canvas: </p> <input type="checkbox" name="fullscreentoggle" id="fullscreentoggle" value="On">\n    </form>\n\n    <a id="exitbutton">Back</a>');
  C.PauseMenu_Fou = new T.PauseMenu("pausemenu", '<h1>Paused</h1>\n    <a id="pausebutton">Resume</a>\n    <a id="optionsbutton">Options</a>\n    <a id="exitbutton">Exit</a>');
  C.Type_MainMenu_mbs = H.createRuntimeType(T.MainMenu);
  C.Type_Null_Yyn = H.createRuntimeType(P.Null);
  C.Type_OptionsMenu_B8J = H.createRuntimeType(T.OptionsMenu);
  C.Type_PauseMenu_6Re = H.createRuntimeType(T.PauseMenu);
  ...
  }, "_Html5NodeValidator__attributeValidators", "ALL_MENUS", "$get$ALL_MENUS", function() {
    return H.setRuntimeTypeInfo([C.MainMenu_ohJ, C.PauseMenu_Fou, C.OptionsMenu_Kdl, C.GameMenu_Tny], [T.Menu]);
  }, "ALL_MENUS", "style", "$get$style", function() {
    return W.document().createElement("style");
  }, "style", "canvas", "$get$canvas", function() {
    var e = W.document().createElement("canvas");
    return e;
  }, "canvas", "title", "$get$title", function() {
    return W.document().createElement("h1");
  }, "title", "context", "$get$context", function() {
    var t1 = $.$get$canvas();
    return H.interceptedTypeCheck((t1 && C.CanvasElement_methods).getContext$1(t1, "2d"), "$isCanvasRenderingContext2D");
  }, "context", "Banner_tribeBanners", "$get$Banner_tribeBanners", function() {
    return H.setRuntimeTypeInfo([54, 55, 56, 57, 58, 59, 60], [P.int]);
  }, "Banner_tribeBanners", "random", "$get$random", function() {
    return C.C__JSRandom;
  }, "random"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: -1, args: [W.MouseEvent]}, {func: 1, ret: -1, args: [W.Element]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: P.bool, args: [T.Menu]}, {func: 1, ret: -1, args: [K.TribeDrone]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.Null, args: [W.KeyboardEvent]}, {func: 1, ret: P.bool, args: [S.Entity]}, {func: 1, ret: -1, args: [S.Entity]}, {func: 1, ret: P.bool, args: [K.Drone]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: -1, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, args: [P.num]}, {func: 1, ret: -1, args: [K.Drone]}, {func: 1, ret: P.bool, args: [K.TribeDrone]}, {func: 1, ret: -1, args: [S.Drawable]}, {func: 1, ret: P.Null, args: [K.HeldTribe]}];
...
//# sourceMappingURL=lunaris.dart.js.map
